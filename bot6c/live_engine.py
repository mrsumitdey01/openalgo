"""
bot6c/live_engine.py
===================
Async multi-asset live execution engine for the Bot6c Scanner.
...
from bot6c.data_layer import LiveFeed
from bot6c.dtc_indicator import compute_dtc, get_actionable_signals
from bot6c.state_manager import StateManager, compute_scanner_quantity
from bot6c.position_manager import Side, ExitReason
from bot6c.config import (
    WATCHLIST,
    SCANNER_START,
    CUTOFF_TIME,
    SQUARE_OFF_TIME,
...
log = logging.getLogger("Bot6c.Live")
...
def run_live(
    ...
    exchange: str = "NSE",
    strategy_name: str = "Bot6c_Scanner",
) -> None:
    """
    ...
    log.info(f"[LIVE] Bot6c Scanner started.")
