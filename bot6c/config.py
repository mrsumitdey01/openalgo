...
bot6c/config.py
==============
All configurable parameters for Bot6c DTC Intraday Strategy.
...
INITIAL_SL_PCT: float = 0.002        # 0.2% hard initial stop loss
...
# LOGGING
# --------------------------------------------------------------------------- #
LOG_FILE: str = "bot6c_trades.log"
TRADE_CSV: str = "bot6c_tradelog.csv"
