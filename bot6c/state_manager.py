"""
bot6c/state_manager.py
=====================
Multi-position state manager for the Bot6c Scanner.
...
from bot6c.position_manager import Position, Side, ExitReason
...
class StateManager:
    """
    Manages the collection of open Bot6c positions across all symbols.
