"""
bot6/state_manager.py
=====================
Multi-position state manager for the Bot6 Scanner.
...
from bot6.position_manager import Position, Side, ExitReason
...
class StateManager:
    """
    Manages the collection of open Bot6 positions across all symbols.
