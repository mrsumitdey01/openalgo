"""
bot6/backtest_engine.py
=======================
Bar-by-bar backtest engine for the Bot6 Multi-Asset Scanner.
...
# Add the openalgo root to path so bot6 imports work
_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
if _ROOT not in sys.path:
    sys.path.insert(0, _ROOT)

from bot6.data_layer import DuckDBFeed
...
from bot6.position_manager import Side
...
log = logging.getLogger("Bot6.Backtest")
